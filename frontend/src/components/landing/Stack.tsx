...
const BANKS = [
  { label: 'Zcash side', note: 'On the holder’s machine, and in anyone’s browser.', rows: ['pof-core', 'pof-prove', 'pof-verify'] },
  ...
  return (
    <div>
      <div className="flex flex-wrap items-baseline justify-between gap-x-6 gap-y-1 border-b border-ink pb-4">
        ...
        <p className="t-data-sm text-ink-3">06 pieces · 1 verifier, compiled twice</p>
      </div>
